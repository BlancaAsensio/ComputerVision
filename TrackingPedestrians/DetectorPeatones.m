...
% Fichero auxiliar que ayuda a determinar la altura de un peatón en función de píxeles.
...
% Parámetros globales que sirven para mejorar el rendimiento del seguimiento. 
...
while true
    ...
    function tracks = initializeTracks()
        % Crea un array vacío que representa cada objeto en movimiento 
        tracks = struct(...
            'id', {}, ...
            'color', {}, ...
            'bboxes', {}, ... % Matriz que representa los cuadros delimitadores
            'scores', {}, ... % Vector para registrar la puntuación de clasificación del detector de personas
            'kalmanFilter', {}, ... % Filtro de Kalman utilizado para trackear. Se trackea el punto central del objeto en la imagen
            'age', {}, ... % Número de fotogramas
            'totalVisibleCount', {}, ...  % Númmero total de fotogramas en los que se consiguió detectar el objeto
    ...
    function [centroids, bboxes, scores] = detectPeople()
        % Cambiamos el tamaño de la imagen para aumentar la resolución
        resizeRatio = 1.5;
        ...
        % Altura estimada del peatón según la ubicación de sus pies
        ...
        % Eliminamos detecciones cuyo tamaño no concuerda con el tamaño esperado
    ...
    function [assignments, unassignedTracks, unassignedDetections] = ...
        ...
        % El objetivo de esta función es asignar detecciones a los trackers minimizando el coste
        % Primero se calcula la relación entre el cuadro delimitador predicho y el detectado
    ...
    function updateAssignedTracks()
        % Actualiza cada tracker asignado con su detección correspondiente
    ...
    function createNewTracks()
        % Crea nuevos trackers según el número de trackers sin asignar
    ...
    function displayTrackingResults()
        ...
        % Se muestra también la puntuación de cada detección
        displayRatio = 4/3;
